...
admin_route.get('/home', auth.isAdmin, adminController.loadDashboard);
...
admin_route.get('/dashboard', auth.isAdmin, adminController.adminDashboard);

admin_route.get('/new-user', auth.isAdmin, adminController.newUserLoad);
